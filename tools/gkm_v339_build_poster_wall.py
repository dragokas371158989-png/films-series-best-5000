#!/usr/bin/env python3
"""Rebuild compact poster_wall_v333 data from the current fast search index."""
...
def main():
    ...
    manifest={"version":"v339-current-search-index-poster-wall-2026-07-12","source":str(SRC),"generatedAt":now(),"total":sum(map(len,pools.values())),"chunkSize":CHUNK,"seed":"seed_all.json","types":list(pools),"kinds":{}}
