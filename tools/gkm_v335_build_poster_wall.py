...
SOURCES=[Path("data/fast/search_lite.json"),Path("data/fast/search_index.json")]
...
def main():
    ...
    manifest={"version":"v337-search-index-hotfix-poster-wall-2026-07-12","source":str(SRC),"generatedAt":now(),"total":sum(map(len,pools.values())),"chunkSize":CHUNK,"seed":"seed_all.json","types":list(pools),"kinds":{}}
